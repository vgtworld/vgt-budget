...
@Named
@RequestScoped
public class MonthlyTagSpendingController {
	...
	private List<TagWithSpendingDto> tagsWithSpending;
	...
	public List<TagWithSpendingDto> getTagsWithSpending() {
		return tagsWithSpending;
	}
	...
	public String initData() {
		...
		tagsWithSpending = tagWithSpendingRepository.listTagsWithBiggestSpending(year, month, null);
